...
def count_genders(people_dict):
    ...
    total_females=total_people-total_males
        
    print (f"Total male: {total_males}")
    print(f"Total female: {total_females}")
    pass

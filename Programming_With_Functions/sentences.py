...
def get_adjective():
    ...
    "adorable", "brave", "calm", "careful", "difficult", "dull", 
    "expensive", "funny", "good", "fancy", "gorgeous", "horrible", "important",
    "grumpy", "homeless", "lazy" , "odd", "plain", "silly"
    """
    adjective = ["adorable", "brave", "calm", "careful", "difficult", "dull", 
                 "expensive", "funny", "good", "fancy", "gorgeous", "horrible", "important",
                 "grumpy", "homeless", "lazy" , "odd", "plain", "silly"]
...
def get_adverb():
    ...
    "slowly", "badly", "sadly", "usually", "always", "also", "previously",
              "cheerfully", "strangely", "loudly", "kindly", "neatly"
    """
    adverb = ["slowly", "badly", "sadly", "usually", "always", "also", "previously",
              "cheerfully", "strangely", "loudly", "kindly", "neatly"]
